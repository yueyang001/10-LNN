...
log_path = "checkpoints/ablation_deepship/num_epochs200_weight_decay8e-05_batch_size16_lr0.0004_distill_typeMTSKD_Temp_freezeTrue_USE_DYNAMIC_DISTILL_WEIGHTFalse_p_encoder0.1_p_classifier0.35/train_20260421_210807.log"
# ========= 正则：严格匹配你的 log =========
...
plt.legend()
plt.title("ACC Curve")
plt.text(0.5, -0.15, '(b)', transform=plt.gca().transAxes,
         ha='center', va='center', fontsize=14)

plt.tight_layout()
plt.savefig("results/best_deepship.png", dpi=200)
print("best_deepship.png")
