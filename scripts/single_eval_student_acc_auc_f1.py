...
def main():
    parser = argparse.ArgumentParser(description='Evaluate Student Model on DeepShip Dataset')
    ...
    p_encoder = config['model']['student'].get('p_encoder', 0.1)
    p_classifier = config['model']['student'].get('p_classifier', 0.2)
    ...
    if 'student_state_dict' in checkpoint:
        ...
        print("  Warning: Checkpoint does not contain 'student_state_dict', using the whole checkpoint")
