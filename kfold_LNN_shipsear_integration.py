...
class LNNShipsearKFoldTrainer:
    ...
    def __init__(self, splits_dir="results/kfold_splits_shipsear", results_dir="results/kfold_cv_lnn_shipsear"):
        """
        参数:
...
def main():
    ...
    parser.add_argument("--splits-dir", type=str, default="results/kfold_splits_shipsear",
                        help="K-Fold划分文件目录")
