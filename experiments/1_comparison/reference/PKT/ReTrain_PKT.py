...
from ResNet_PKT import resnet18
from Student_PKT import StudentNet
from ReDataset import ReDataset
from PKTLoss import PKT
...
if __name__ == '__main__':
    ...
    snapshot_path = './Checkpoints_EarShip_PKT/'
        ...
        for phase in ['train', 'test']:
            ...
            for i, (inputs, label) in enumerate(dataset[phase]):
                ...
                with torch.set_grad_enabled(phase == 'train'):
                    teacher_output, teacher_pkt = model_T(inputs)
                    student_output, student_pkt = model_S(inputs)
                    ...
                    loss_pkt = criterion_pkt(student_pkt.view(student_pkt.size(0), -1),
                                             teacher_pkt.view(teacher_pkt.size(0), -1))
                    loss = loss_task + loss_kl + loss_pkt
