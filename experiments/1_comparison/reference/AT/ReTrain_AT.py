...
from ResNet_AT import resnet18
from Student_AT import StudentNet
...
if __name__ == '__main__':
    ...
    snapshot_path = './Checkpoints_EarShip_AT/'
        ...
        for phase in ['train', 'test']:
            ...
            for i, (inputs, label) in enumerate(dataset[phase]):
                ...
                with torch.set_grad_enabled(phase == 'train'):
                    teacher_output, teacher_AT = model_T(inputs)
                    student_output, student_AT = model_S(inputs)
                    ...
                    loss_AT = criterion_AT(student_AT, teacher_AT)
                    loss = loss_task + loss_kl + loss_AT[0] + loss_AT[1] + loss_AT[2]
