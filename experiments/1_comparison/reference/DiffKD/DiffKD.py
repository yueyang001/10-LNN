...
class DiffKD(nn.Module):
    def __init__(
        ...
        self.trans = nn.Conv2d(student_channels, teacher_channels, 3, 2, 1)
    ...
    def forward(self, image):
        s_out, (_, _, student_feat) = self.student(image)
        _, (_, _, teacher_feat) = self.teacher(image)
