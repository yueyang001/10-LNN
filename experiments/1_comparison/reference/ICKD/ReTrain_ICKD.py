...
from ResNet_ICKD import resnet18
from Student_ICKD import StudentNet
from ReDataset import ReDataset
from Distillation_ICKD import DistillationModel
...
if __name__ == '__main__':
    ...
    snapshot_path = './Checkpoints_EarShip_ICKD/'
        ...
        for phase in ['train', 'test']:
            ...
            for i, (inputs, label) in enumerate(dataset[phase]):
                ...
                with torch.set_grad_enabled(phase == 'train'):
                    teacher_output, student_output, teacher_icc, student_icc = model(inputs)
                    ...
                    loss_icc = criterion_icc(student_icc, teacher_icc)
                    loss = loss_task + loss_kl + 2.5 * loss_icc
