...
from ResNet_KD import resnet18
from Student_KD import StudentNet
...
if __name__ == '__main__':
    ...
    snapshot_path = './Checkpoints_EarShip_KD/'
        ...
        for phase in ['train', 'test']:
            ...
            for i, (inputs, label) in enumerate(dataset[phase]):
                ...
                with torch.set_grad_enabled(phase == 'train'):
                    ...
                    loss_kl = criterion_KL(student_output_T, teacher_output_T) * (T ** 2) / inputs.shape[0]
                    loss = 0.1 * loss_task + 0.9 * loss_kl
