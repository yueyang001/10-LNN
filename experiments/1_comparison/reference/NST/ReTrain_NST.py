...
from ResNet_NST import resnet18
from Student_NST import StudentNet
...
if __name__ == '__main__':
    ...
    snapshot_path = './Checkpoints_EarShip_NST/'
        ...
        for phase in ['train', 'test']:
            ...
            for i, (inputs, label) in enumerate(dataset[phase]):
                ...
                with torch.set_grad_enabled(phase == 'train'):
                    teacher_output, teacher_nst = model_T(inputs)
                    student_output, student_nst = model_S(inputs)
                    ...
                    loss_nst = criterion_nst(student_nst, teacher_nst)
                    loss = loss_task + loss_kl + loss_nst[0] + loss_nst[1] + loss_nst[2]
