...
from ResNet_CC import resnet18
from Student_CC import StudentNet
from ReDataset import ReDataset
from CCLoss import Correlation
...
if __name__ == '__main__':
    ...
    snapshot_path = './Checkpoints_EarShip_CC/'
        ...
        for phase in ['train', 'test']:
            ...
            for i, (inputs, label) in enumerate(dataset[phase]):
                ...
                with torch.set_grad_enabled(phase == 'train'):
                    teacher_output = model_T(inputs)
                    student_output = model_S(inputs)
                    ...
                    loss_cc = criterion_cc(student_output, teacher_output)
                    loss = 0.1 * loss_task + 0.9 * loss_kl + loss_cc
