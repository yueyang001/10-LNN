...
from LSKD import DistillKL_logit_stand
...
if __name__ == '__main__':
    ...
    snapshot_path = './CheckPoints/DeepShip_LSKD/'
    ...
    for cross in range(args.num_train_test):
        ...
        criterion_lskd = DistillKL_logit_stand()
        ...
        for epoch in range(1, args.num_epochs + 1):
            ...
            for index, (mel, label) in enumerate(train_loader):
                ...
                loss_lskd = criterion_lskd(s_out, t_out, 3)
                loss = loss_task + loss_lskd
