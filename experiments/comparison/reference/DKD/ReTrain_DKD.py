...
from ResNet_DKD import resnet18
from Student_DKD import StudentNet
...
if __name__ == '__main__':
    ...
    snapshot_path = './Checkpoints_EarShip_DKD/'
        ...
        for phase in ['train', 'test']:
            ...
            for i, (inputs, label) in enumerate(dataset[phase]):
                ...
                with torch.set_grad_enabled(phase == 'train'):
                    ...
                    loss_DKD = criterion_DKD(student_output, teacher_output, label, 1, 1, 3)
                    loss = loss_task + loss_DKD
