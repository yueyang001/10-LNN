...
from ResNet_RKD import resnet18
from Student_RKD import StudentNet
from ReDataset import ReDataset
from RKDLoss import RKDLoss
...
if __name__ == '__main__':
    ...
    snapshot_path = './Checkpoints_EarShip_RKD/'
        ...
        for phase in ['train', 'test']:
            ...
            for i, (inputs, label) in enumerate(dataset[phase]):
                ...
                with torch.set_grad_enabled(phase == 'train'):
                    teacher_output, teacher_rkd = model_T(inputs)
                    student_output, student_rkd = model_S(inputs)
                    ...
                    loss_rkd = criterion_rkd(student_rkd, teacher_rkd)
                    loss = loss_task + loss_kl + loss_rkd
