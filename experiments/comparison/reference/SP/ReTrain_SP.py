...
from ResNet_SP import resnet18
from Student_SP import StudentNet
...
if __name__ == '__main__':
    ...
    snapshot_path = './Checkpoints_EarShip_SP/'
        ...
        for phase in ['train', 'test']:
            ...
            for i, (inputs, label) in enumerate(dataset[phase]):
                ...
                with torch.set_grad_enabled(phase == 'train'):
                    teacher_output, teacher_SP = model_T(inputs)
                    student_output, student_SP = model_S(inputs)
                    ...
                    loss_SP = criterion_SP(student_SP, teacher_SP)
                    loss = loss_task + loss_kl + loss_SP[0] + loss_SP[1] + loss_SP[2]
